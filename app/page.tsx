          ...
          <div className="pt-8">
            ...
            <div className="flex justify-center gap-8">
              {[
                ...
                {
                  color: "#0A66C2",
                  path: "M22.23 0H1.77C0.79 0 0 0.774 0 1.729v20.542C0 23.226 0.79 24 1.77 24h20.46C23.21 24 24 23.226 24 22.271V1.729C24 0.774 23.21 0 22.23 0zM7.074 20.452H3.837V9.045h3.237v11.407zM5.456 7.719a1.875 1.875 0 1 1 0-3.75 1.875 1.875 0 0 1 0 3.75zm15.368 12.733h-3.237v-5.562c0-1.327-.027-3.036-1.849-3.036-1.849 0-2.132 1.444-2.132 2.938v5.66H10.37V9.045h3.107v1.561h.045c.433-.82 1.491-1.684 3.066-1.684 3.277 0 3.882 2.157 3.882 4.962v6.568z",
                },
                {
                  color: "#9146FF",
